...
var world [5000][5000]bool

// Moves takes a string of move runes like ^,v,<,>
func Moves(moves string) int {

	world = [5000][5000]bool{}
	row := 2500
	col := 2500

	// Place a present at starting location
	world[row][col] = true
	for _, move := range moves {
		row, col = makeMove(row, col, move)
	}
	return countWorld()
}

// RoboMoves moves every other with santa, others with robo
func RoboMoves(moves string) int {
	world = [5000][5000]bool{}
	santaRow := 2500
	santaCol := 2500
	roboRow := 2500
	...
	// Place a present at starting location
	world[santaRow][santaCol] = true
	for i, move := range moves {
		if i%2 == 0 {
			santaRow, santaCol = makeMove(santaRow, santaCol, move)
		} else {
			roboRow, roboCol = makeMove(roboRow, roboCol, move)
		}
	}
	return countWorld()
}
...
func makeMove(row int, col int, move rune) (int, int) {
	switch move {
	case '<':
		col--
	case '>':
